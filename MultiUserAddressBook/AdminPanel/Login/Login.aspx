...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class ="col-md-6">
                <h2 class="text-center" align="center" >Login For Existing User</h2>
            ...
            <div class ="col-md-6">
                <h2 class="text-center " align="center">Sign UP For New User</h2>
                <table class="table table-secondary">
                    <tr>
                        <td colspan="3" class="text-center">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <asp:TextBox ID="txtEmailSignup" runat="server" CssClass="form-control"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" class="text-center">
                            <asp:Button runat="server" ID="btnSignup" Text="Sign Up" CssClass="btn btn-info" OnClick="btnSignup_Click"/>
                        </td>
                    </tr>
                </table>
            </div>
